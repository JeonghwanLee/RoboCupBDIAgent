...
//
//***************************************************************************
class Player implements SendCommand
{
	//===========================================================================
	// Private members
	// class members
	...
	try
		...
		Player player = new Player(InetAddress.getByName(hostName), port, team);
    ...
    public Player(InetAddress host, int port, String team)
