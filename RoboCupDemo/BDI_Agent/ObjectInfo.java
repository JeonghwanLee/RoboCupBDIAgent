...
public class ObjectInfo
{
  ...
  public void getPosition()
  {
    ...
    m_x = Math.cos(angle)*m_distance;
    m_y = Math.sin(angle)*m_distance;

  }

  public double getDistance(ObjectInfo second)
  {
    double x = second.m_x - this.m_x;
    double y = second.m_y - this.m_y;
